      ...
      `}>
        ...
        {evaluatorName && (
          <div className="p-8 border-t border-white/5 bg-[#001326]">
            <div className={`p-5 rounded-3xl border-2 ${isBonusApprover ? 'bg-indigo-900/30 border-[#FFCC00]/50' : 'bg-white/5 border-white/10'}`}>
              <div className="flex items-center">
                <div className={`shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center text-sm font-black ${isBonusApprover ? 'bg-[#FFCC00] text-[#003366]' : 'bg-[#003366] text-white shadow-lg'}`}>
        ...
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md shadow-sm border-b border-slate-100 px-6 lg:px-10 py-4 lg:py-5 flex justify-between items-center print:hidden">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-base lg:text-xl font-black text-slate-800 leading-tight uppercase tracking-tight">
                {isBonusApprover ? 'Gestión de Beneficios' : 'Sistema de Evaluación Técnica'}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 lg:gap-8">
            <div className="hidden xl:flex flex-col text-right">
              ...
              <span className={`text-[9px] font-black uppercase tracking-[0.2em] mt-1 ${isBonusApprover ? 'text-[#003366]' : 'text-emerald-500'}`}>
                ● CONEXIÓN SEGURA
              </span>
            </div>
